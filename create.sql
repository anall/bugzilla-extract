...
CREATE TABLE buginfo (bug_id INTEGER PRIMARY KEY, subject TEXT, product TEXT, component TEXT, severity TEXT, priority TEXT, status TEXT, assigned TEXT, is_security CHAR(1), last_update DATE);
